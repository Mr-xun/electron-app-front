    ...
    <div class="record-container">
        <div class="header-query">
            <el-form :inline="true" :model="queryForm" class="demo-form-inline">
                <el-form-item label="订单编号">
                    <el-input size="medium" clearable v-model="queryForm.order_num" placeholder="订单编号"></el-input>
                </el-form-item>
                <el-form-item label="商户">
                    <el-select clearable v-model="queryForm.merchant" placeholder="商户">
                ...
                <el-form-item label="创建日期">
                    <el-date-picker v-model="queryForm.create_time" value-format="yyyy-MM-dd" type="daterange"
        ...
        <div class="list-wrap">
            <el-timeline :reverse="true">
                <el-timeline-item :timestamp="item.create_time" placement="top" color="#0bbd87"
                    v-for="(item,index) in orderData" :key="index">
                    <el-card>
                        <h4>
                            <span class="merchant-title">订单编号：{{item.order_num||'---'}}</span>
                            <span class="merchant-title">商户：{{item.merchant_name||'---'}}</span>
                            创建者：{{item.create_user}}
                        </h4>
                        <el-table :data="item.order_content" border show-summary :summary-method="getSummaries"
                            style="width: 100%">
...
export default class OrderList extends Vue {
    ...
    private getOrderList() {
        ...
        let params = {
            ...
            merchant_code: this.queryForm.merchant,
            startTime: this.queryForm.create_time
                ? this.queryForm.create_time[0] + " 00:00:00"
                : "",
            endTime: this.queryForm.create_time
                ? this.queryForm.create_time[1] + " 23:59:59"
                : "",
            pageSize: this.pagination.pageSize,
            pageNum: this.pagination.currentPage
        };
        api.wholesaleOrder_getOrder(params)
            .then(res => {
