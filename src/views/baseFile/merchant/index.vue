<template>
  <div class="merchant-container main-content-container">
    <div class="header-query">
      <el-form :inline="true" :model="merchantForm" class="demo-form-inline">
        ...
        <el-form-item>
          <el-button size="medium" type="primary"  @click="startSearch" :loading="tableLoading">查询</el-button>
    ...
    element-loading-background="rgba(255, 255, 255, 0.5)">
        ...
        <el-table-column min-width="120" align="center" prop="merchant_concactMethod" label="联系方式"></el-table-column>
        <el-table-column align="center" prop="merchant_area" label="区域"></el-table-column>
        <el-table-column min-width="160" align="center" prop="merchant_adress" label="地址"><template  slot-scope="scope">
...
params.pageNum = this.pagination.currentPage;
      ...
      api.merchant_list(params).then(res=>{
          console.log(res)
