  ...
  <div class="merchant-container">
    ...
    <div class="list-wrap">
      ...
      >
        ...
        <el-table-column min-width="160" align="center" prop="merchant_adress" label="地址">
          <template slot-scope="scope">
            <span>{{scope.row.merchant_adress || "---"}}</span>
          </template>
        </el-table-column>
        <el-table-column align="center" prop="merchant_code" label="编码">
          <template slot-scope="scope">
    ...
    <merchant-edit
      :editMctVisible.sync="editMctVisible"
      :editMctForm="editMctForm"
      :editMctTitle="editMctTitle"
      :editMctId="editMctId"
      @initList="getMerchantList"
    ></merchant-edit>
  </div>
</template>
<script lang='ts'>
