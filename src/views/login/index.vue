<template>
  <div class="login-container">
    ...
    <el-dialog title="修改密码" :visible.sync="dialogFormVisible" class="resetPwd-dialog">
...
export default class Login extends Vue {
  ...
  private resetPwdRules: object = {
    ...
    verify_one: [{ required: true, message: "请输入公司名", trigger: "blur" }],
    verify_two: [{ required: true, message: "请输入男主名", trigger: "blur" }],
    verify_three: [{ required: true, message: "请输入女主名", trigger: "blur" }],
  ...
  sureResetPwd() {
    let params = {
      ...
      verify_one: this.resetPwdForm.verify_one,
      verify_two: this.resetPwdForm.verify_two,
      verify_three: this.resetPwdForm.verify_three,
      newpwd: this.resetPwdForm.newpwd,
