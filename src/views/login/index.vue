<template>
    <div class="login-container">
        ...
        <el-dialog title="修改密码" :visible.sync="dialogFormVisible" style="width:80%;">
            <el-form :model="resetPwdForm" label-width="80px">
                <el-form-item label="用户名">
                    <el-input v-model="resetPwdForm.username" style="width:80%;" autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item label="公司名">
                    <el-input v-model="resetPwdForm.verify_one" style="width:80%;" autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item label="男主名">
                    <el-input v-model="resetPwdForm.verify_two" style="width:80%;" autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item label="女主名">
                    <el-input v-model="resetPwdForm.verify_three" style="width:80%;" autocomplete="off"></el-input>
                </el-form-item>
            </el-form>
